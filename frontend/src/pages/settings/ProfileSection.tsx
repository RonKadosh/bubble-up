 ...
 * Rendered inside the Settings page's Profile tab. Read-only views of *other*
 * users still live in ProfilePage (`/profile/:userId`).
 */
export default function ProfileSection() {
  ...
  // Edit form state — derived from profile on enter-edit.
  ...
  useEffect(() => {
    ...
    getMyProfile()
      ...
      .catch(() => { if (!cancelled) setError(t('profile.errorLoad')) })
